...
attr_tabel_individuele_tickers_sel_ff_nice <- function(portfolio = "VP100", start_date = last_ultimo_year, end_date = snapshot_date) {
  ...
  tabel_nice <-
      ...
      gt(id = "one") |>
      fmt_percent(columns = c(wt_in_RD, wt_in_bm, `wt_in_RD `, `wt_in_bm `, OU, `OU `, trr_eur, sel_ff), decimals = 2) |>
      fmt_number(columns = c(price, `price `), decimals = 2) |>
      ...
      sub_missing(missing_text = "") |>   # Replaces NA with empty string (whitespace)
